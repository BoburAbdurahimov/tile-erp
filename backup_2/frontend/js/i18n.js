const I18N = {
  uz: {
    ...
    nav_mdm: "MDM (Spravochniklar)",
    nav_ombor: "Ombor (Sklad)",
    nav_kassa: "Kassa & Moliya oqimi",
    nav_production: "Ishlab chiqarish (5 Liniya)",
    nav_balances: "Mijoz & Postavshik balansi",
    nav_purchases: "Sotib olish (Zakup)",
    nav_sales: "Sotish (Realizatsiya)",
    nav_finance: "Moliya & PnL & Oyni yopish",
    nav_users: "Foydalanuvchilar (Admin)",
    ...
    th_actions: "Amallar",
    th_warehouse: "Ombor",
    th_counterparty: "Kontragent",
    th_currency: "Valyuta",
    th_description: "Izoh",
    
    // Module Titles
    mod_mdm_title: "MDM: Spravochniklar va Asosiy Ma'lumotlar",
    mod_ombor_title: "Ombor hisobi va Materiallar qoldig'i (AVG narxda)",
    mod_kassa_title: "Kassa hisobi va Pul oqimi (Cash Flow)",
    mod_prod_title: "Ishlab chiqarish hisobi (5 ta Liniya)",
    mod_balances_title: "Mijozlar va Yetkazib beruvchilar hisob-kitob balansi",
    mod_zakup_title: "Sotib olish va Ta'minot (Zakup)",
  ...
  ru: {
    ...
    nav_mdm: "MDM (Справочники)",
    nav_ombor: "Склад (Остатки)",
    nav_kassa: "Касса и Денежные средства",
    nav_production: "Производство (5 Линий)",
    nav_balances: "Балансы контрагентов",
    nav_purchases: "Закупки (Закуп)",
    nav_sales: "Продажи (Реализация)",
    nav_finance: "Финансы & PnL & Закрытие",
    nav_users: "Пользователи (Admin)",
    ...
    mod_ombor_title: "Складской учет и Остатки (по методу AVG)",
    mod_kassa_title: "Учет денежных средств (Касса)",
    mod_prod_title: "Производственный учет (5 Линий)",
    mod_balances_title: "Взаиморасчеты с контрагентами",
    mod_zakup_title: "Закупки и Поступления (Закуп)",
