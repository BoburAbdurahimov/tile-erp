...
class User(Base):
    ...
    role = Column(String(30), nullable=False, default="Ish boshqaruvchi") # Admin, Ish boshqaruvchi, Direktor
...
class TelegramUser(Base):
    ...
    role = Column(String(30), default="Admin") # Default first user or "Admin" / "Ish boshqaruvchi" / "Direktor" / "Kutilmoqda"
